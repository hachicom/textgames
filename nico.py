...
def show_instructions():
    ...
    print()
    print('Nico começa o jogo com {} pontos de energia, {} petiscos e {} elásticos.'.format(QTD_INITHP,QTD_INITFOOD,QTD_INITFIRE))
...
class Player:
    def __init__(self, name, goal, time):
        ...
        self.win = False
        self.hp = QTD_INITHP
        self.maxhp = QTD_INITHP
        self.food = QTD_INITFOOD
        self.fire = QTD_INITFIRE
        self.kills = 0
        self.allies = []
        self.goal = goal
        self.time = time
